...
def toggle_eyes( )
    color=c.itemcget(eye_left, 'fill')
...
fill=c.body_color)
ear_left = c.create_polugon(75, 80, 10, 165, 70, 
...
outline=c.body_color, fill= c.body_color)
eye_left = c.crecte_oval(130, 110, 160, 170, outline='black' ,
fill='white')
...
smooth=1, width=2, state=NORMAI)


mouty_happy = c.create_line(170, 250, 200, 282, 230, 250, 
...
der show_happy(event):
	if (20 <= event .x <= 350 ) and (20 <= event .y <= 350 ):
		c.itemconfigure(cheek_left, state=NORMAL)
		c.itemconfigure(cheek_right, stateNORMAL)
